...
public class OverTriangulator implements Triangulator {
	...
	/**
	 * @see org.starfire.shine.geom.Triangulator#addPolyPoint(float, float)
	 */
	public void addPolyPoint(float x, float y) {
	}

	/**
	 * @see org.starfire.shine.geom.Triangulator#getTriangleCount()
	 */
	...
	/**
	 * @see org.starfire.shine.geom.Triangulator#getTrianglePoint(int, int)
	 */
	...
	/**
	 * @see org.starfire.shine.geom.Triangulator#startHole()
	 */
	public void startHole() {
	}

	/**
	 * @see org.starfire.shine.geom.Triangulator#triangulate()
	 */
