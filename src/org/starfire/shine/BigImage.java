...
import org.starfire.shine.opengl.ImageData;
import org.starfire.shine.opengl.ImageDataFactory;
import org.starfire.shine.opengl.LoadableImageData;
import org.starfire.shine.opengl.Texture;
import org.starfire.shine.opengl.renderer.SGL;
import org.starfire.shine.opengl.renderer.Renderer;
import org.starfire.shine.util.OperationNotSupportedException;
import org.starfire.shine.util.ResourceLoader;
...
public class BigImage extends Image {
	 ...
	 * 
	 * @see org.starfire.shine.Image#bind()
	 */
	public void bind() {
	 ...
	 * Not supported in BigImage
	 * 
	 * @see org.starfire.shine.Image#copy()
	 */
	public Image copy() {
	...
	/**
	 * @see org.starfire.shine.Image#draw()
	 */
	public void draw() {
		draw(0,0);
	}
	...
	/**
	 * @see org.starfire.shine.Image#draw(float, float, org.starfire.shine.Color)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#draw(float, float, float, org.starfire.shine.Color)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#draw(float, float, float, float, org.starfire.shine.Color)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#draw(float, float, float, float, float, float, float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#draw(float, float, float, float, float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#draw(float, float, float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#draw(float, float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#draw(float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#drawEmbedded(float, float, float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#drawFlash(float, float, float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#drawFlash(float, float)
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see org.starfire.shine.Image#endUse()
	 */
	public void endUse() {
		if (lastBind != null) {
			lastBind.endUse();
	 ...
	 * Not supported in BigImage
	 * 
	 * @see org.starfire.shine.Image#startUse()
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see org.starfire.shine.Image#ensureInverted()
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see org.starfire.shine.Image#getColor(int, int)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#getFlippedCopy(boolean, boolean)
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see org.starfire.shine.Image#getGraphics()
	 */
	...
	/** 
	 * @see org.starfire.shine.Image#getScaledCopy(float)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#getScaledCopy(int, int)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#getSubImage(int, int, int, int)
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see org.starfire.shine.Image#getTexture()
	 */
	...
	/**
	 * @see org.starfire.shine.Image#initImpl()
	 */
	...
	/**
	 * @see org.starfire.shine.Image#reinit()
	 */
	 ...
	 * Not supported in BigImage
	 * 
	 * @see org.starfire.shine.Image#setTexture(org.starfire.shine.opengl.Texture)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#toString()
	 */
	...
	/**
	 * @see org.starfire.shine.Image#draw(float, float, float, float, float, float, float, float, org.starfire.shine.Color)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#drawCentered(float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#drawEmbedded(float, float, float, float, float, float, float, float, org.starfire.shine.Color)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#drawEmbedded(float, float, float, float, float, float, float, float)
	 */
	public void drawEmbedded(float x, float y, float x2, float y2, float srcx,
	...
	/**
	 * @see org.starfire.shine.Image#drawFlash(float, float, float, float, org.starfire.shine.Color)
	 */
	...
	/**
	 * @see org.starfire.shine.Image#drawSheared(float, float, float, float)
	 */
