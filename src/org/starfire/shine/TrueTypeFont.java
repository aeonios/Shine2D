...
import org.starfire.shine.opengl.GLUtils;
...
import org.starfire.shine.util.BufferedImageUtil;
 ...
 */
public class TrueTypeFont implements org.starfire.shine.Font {
    ...
    /**
     * In this case equal to {@link org.starfire.shine.Font#getLogicalWidth(String)}
	...
	public void drawString(float x, float y, String whatchars,
			org.starfire.shine.Color color) {
		drawString(x,y,whatchars,color,0,whatchars.length()-1);
	}
	
	/**
	 * @see Font#drawString(float, float, String, org.starfire.shine.Color, int, int)
	 */
	public void drawString(float x, float y, String whatchars,
			org.starfire.shine.Color color, int startIndex, int endIndex) {
		color.bind();
		fontTexture.bind();
	 ...
	 */
	public void drawString(float x, float y, String whatchars) {
		drawString(x, y, whatchars, org.starfire.shine.Color.white);
	}
