...
public class VAOGLRenderer extends ImmediateModeOGLRenderer {
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#initDisplay(int, int)
	 */
	...
	private void flushBuffer() {	
		...
		GL11.glVertexPointer(3,0,1,vertices);
		GL11.glColorPointer(4,0,1,colors);
		GL11.glTexCoordPointer(2,0,1,textures);
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#flush()
	 */
	public void flush() {
		super.flush();
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glBegin(int)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glColor4f(float, float, float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glEnd()
	 */
	public void glEnd() {
		if (listMode > 0) {
			super.glEnd();
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glTexCoord2f(float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glVertex2f(float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glVertex3f(float, float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glBindTexture(int, int)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glBlendFunc(int, int)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glCallList(int)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glClear(int)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glClipPlane(int, java.nio.DoubleBuffer)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glColorMask(boolean, boolean, boolean, boolean)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glDisable(int)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glEnable(int)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glLineWidth(float)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glPointSize(float)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glPopMatrix()
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glPushMatrix()
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glRotatef(float, float, float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glScalef(float, float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glScissor(int, int, int, int)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glTexEnvi(int, int, int)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glTranslatef(float, float, float)
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glEndList()
	 */
	...
	/**
	 * @see org.starfire.shine.opengl.renderer.ImmediateModeOGLRenderer#glNewList(int, int)
	 */
