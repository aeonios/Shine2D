...
public final class Log {
	...
	/** true if activated by the system property "org.starfire.shine.forceVerboseLog" */
	 ...
	 * value must be "true"
	 */
	private static final String forceVerboseProperty = "org.starfire.shine.forceVerboseLog";
	 ...
	 * "org.starfire.shine.forceVerboseLog"
	 * 
	...
	/**
	 * Check if the system property org.starfire.shine.verboseLog is set to true.
	 ...
	 * Only be called when system property "org.starfire.shine.forceVerboseLog" is set to true.
